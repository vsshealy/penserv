<?php 
    /**
     * php/parts/sections/services/consulting/section-details.php
     * @package PenServ
     * @author Scott Shealy
     * @version 1.1.0
     * Created | 8/14/2019
...
<?php 
    ...
    $servicesConsultingListing = new WP_Query($servicesConsulting);
?>
...
<section class="section-details">
    <div class="wrapper-inner row">
        <div class="col-xl-12">
            ...
            <?php if($servicesConsultingListing -> have_posts()) : ?>
                <?php while ($servicesConsultingListing -> have_posts()) : $servicesConsultingListing -> the_post(); ?>
