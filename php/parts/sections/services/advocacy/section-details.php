<?php 
    /**
     * php/parts/sections/services/advocacy/section-details.php
     * @package PenServ
     * @author Scott Shealy
     * @version 1.1.0
     * Created | 8/14/2019
...
<?php 
    ...
    $servicesAdvocacyListing = new WP_Query($servicesAdvocacy);
?>
...
<section class="section-details">
    <div class="wrapper-inner row">
        <div class="col-xl-12">
            ...
            <?php if($servicesAdvocacyListing -> have_posts()) : ?>
                <?php while ($servicesAdvocacyListing -> have_posts()) : $servicesAdvocacyListing -> the_post(); ?>
